export const Work = () => {
	...
	return (
		<div className="flex flex-col items-center min-h-screen bg-slate-900 pt-[60px] font-[Inter]">
			...
			<div className="flex flex-wrap gap-8 justify-center mt-[60px]">
				<div className="flex flex-col justify-end transition-all h-[200px] w-[350px] max-md:w-[83%] border border-[rgba(255,255,255,0.1)] rounded-[15px] bg-[url(./assets/ebay-clone.png)] bg-cover bg-no-repeat group">
				...
				<div className="flex flex-col justify-end transition-all h-[200px] w-[350px] max-md:w-[83%] border border-[rgba(255,255,255,0.1)] rounded-[15px] bg-[url(./assets/youtube-clone.png)] bg-cover bg-no-repeat group">
